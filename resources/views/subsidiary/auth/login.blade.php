        ...
        <div class="container mx-auto">
            <div class="flex items-center h-screen justify-center">
                <div class="bg-white h-fit p-5 rounded-lg shadow-lg w-1/3">
                    <div class="text-3xl font-bold mb-5 text-center">Subsidiary Login</div>
                    <form method="POST" action="{{ route('subsidiary.login') }}">
                        @csrf
                        <div class="mb-5">
                        ...
                        <button type="submit" class="bg-green-600 text-white px-4 py-3 rounded-full w-full">Login</button>
                    </form>
                </div>
            </div>
        </div>
